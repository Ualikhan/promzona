...
$allowedExtensions = array('jpg','jpeg','gif','png','xls','xlsx','doc','docx', 'pdf', 'zip', 'rar');
...
class qqFileUploader {
    ...
    function handleUpload($uploadDirectory, $replaceOldFile = FALSE){
        ...
        $filename = "file_".time()."_".rand(0, 1000000000);
        
		$this->uploadName = $filename . $ext;
		
        if ($this->file->save($uploadDirectory . DIRECTORY_SEPARATOR . $filename . $ext)){
            return array('success'=>true, 'filename' => $filename . $ext, 'filesize'=>$size);
        } else {
...
$uploader = new qqFileUploader($allowedExtensions, $sizeLimit);
$result = $uploader->handleUpload('cms/uploads_temp/');
